...
- Revision of the data pipeline that transforms the raw input data into the model outputs. This includes the handling of data cleaning and outlier detection, the pre-processing phase, the model training and its model evaluation
...
- Review and investigate if the use of non-fungible tokens (NFTs) can add value to the company/clients/investors
...
- Consider new ways of improving the tokenmics, such as providing staking or quoting on a automated-market maker (in which case which one to choose)
